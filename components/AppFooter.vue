    ...
    <div class="mx-auto max-w-7xl overflow-hidden px-6 py-16 sm:py-20 lg:px-8">
      <nav class="-mb-6 flex flex-wrap justify-center gap-x-12 gap-y-3 text-sm font-medium" aria-label="Footer">
        <a
          ...
          :key="item.name"
          :href="item.href"
          class="text-gray-300 transition-colors hover:text-indigo-400"
        >
          {{ item.name }}
        </a>
      </nav>
      ...
      <div class="mt-12 flex flex-wrap justify-center gap-x-6 gap-y-4">
        <a
          ...
          target="_blank"
          rel="noopener"
          class="rounded-full p-2 text-gray-300 transition-colors hover:bg-indigo-500 hover:text-white"
        >
      ...
      <div class="mt-10 text-center text-sm text-gray-400">
        <p>
          ...
          <a
            ...
            target="_blank"
            rel="noopener"
            class="text-gray-200 hover:text-indigo-400 hover:underline"
          >
            Gianluca Tiengo
          </a>
          | All rights reserved.
        </p>
        <p class="mt-2">Private reading, tuned for focus.</p>
      </div>
    </div>
  </footer>
</template>
